	                        ...
	                        <form class="pt-3" action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="input-group">
	                                    ...
	                                    <input type="password" class="form-control form-control-lg border-left-0 password_confirmation" name="password_confirmation" id="password_confirmation" placeholder="Confirmation Password">
	                                </div>
	                            </div>
	                            <div class="my-3">
	...
	<script>
	    $(document).ready(function() {
	        $('.btn-register').click(function() {
	            ...
	            var confirmation_password = $('.password_confirmation').val();
	            if(!email) {
	                $.toast({
	                ...
	                $.toast({
	                    ...
	                    text: 'Confirmation Password should be same with a Password.',
	                    position: "top-right",
	                    icon: 'info',
	                    stack: false,
	                    loaderBg: '#46c35f'
